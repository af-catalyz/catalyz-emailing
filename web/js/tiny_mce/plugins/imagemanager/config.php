...
$mcImageManagerConfig['general.language'] = sfConfig::get('app_catalyz_language','fr'); // en, sv
...
// Preview options
//$mcImageManagerConfig['preview.wwwroot'] = realpath(dirname(__FILE__).'/../../../../../../../web'); // absolute or relative from this script path, try to leave blank system figures it out.
$mcImageManagerConfig['preview.wwwroot'] = sfConfig::get('sf_web_dir'); // absolute or relative from this script path, try to leave blank system figures it out.
...
$mcImageManagerConfig['filesystem.path'] = '/uploads/assets'; // absolute or relative from this script path, optional.
$mcImageManagerConfig['filesystem.rootpath'] = sfConfig::get('sf_upload_dir').'/assets'; // absolute or relative from this script path, required.
$mcImageManagerConfig['filesystem.datefmt'] = "Y-m-d H:i";
$mcImageManagerConfig['filesystem.include_directory_pattern'] = '';
$mcImageManagerConfig['filesystem.exclude_directory_pattern'] = '/^mcith$|^\.svn$/i';
