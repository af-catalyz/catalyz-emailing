...
$mcFileManagerConfig['general.language'] = sfConfig::get('app_catalyz_language','fr'); // en, sv
...
//$mcFileManagerConfig['filesystem.rootpath'] = realpath(dirname(__FILE__).'/../../../../../../../web/uploads/assets'); // absolute or relative from this script path.
$mcFileManagerConfig['filesystem.rootpath'] = sfConfig::get('sf_upload_dir').'/assets'; // absolute or relative from this script path.
$mcFileManagerConfig['filesystem.datefmt'] = "Y-m-d H:i";
$mcFileManagerConfig['filesystem.include_directory_pattern'] = '';
$mcFileManagerConfig['filesystem.exclude_directory_pattern'] = '/([^a-zA-Z0-9_\-\.]|^mcith|^\.svn)/i';
...
$mcFileManagerConfig['filesystem.extensions'] = sfConfig::get('app_catalyz_tinymce_filesystem_extensions',"gif,jpg,htm,html,pdf,zip,txt,php,png,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv,xls,xlsx,doc,docx");
...
$mcFileManagerConfig['upload.extensions'] = sfConfig::get('app_catalyz_tinymce_upload_extensions',"gif,jpg,png,pdf,zip,xls,xlsx,doc,docx,swf");
...
$mcFileManagerConfig['download.extensions'] = sfConfig::get('app_catalyz_tinymce_download_extensions',"gif,jpg,htm,html,pdf,txt,zip,xls,xlsx,doc,docx,swf");
