...
abstract class BaseCampaignFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'web_tracker_enabled'               => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'web_tracker_enabled'               => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
