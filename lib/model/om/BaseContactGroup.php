...
abstract class BaseContactGroup extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the is_test_group field.
	 * Note: this column has a database default value of: false
	 * @var        boolean
	 */
	protected $is_test_group;
	...
	{
		$this->is_test_group = false;
		$this->is_archived = false;
	}

	/**
	 * Initializes internal state of BaseContactGroup object.
	 * @see        applyDefaults()
	 */
	...
	/**
	 * Get the [is_test_group] column value.
	 * 
	 * @return     boolean
	 */
	public function getIsTestGroup()
	{
		return $this->is_test_group;
	}
	...
	public function setSlug($v)
	{
		...
		if ($this->slug !== $v) {
			$this->slug = $v;
			$this->modifiedColumns[] = ContactGroupPeer::SLUG;
		}
	...
	/**
	 * Set the value of [is_test_group] column.
	 * 
	 * @param      boolean $v new value
	 * @return     ContactGroup The current object (for fluent API support)
	 */
	public function setIsTestGroup($v)
	{
		if ($v !== null) {
			$v = (boolean) $v;
		}

		if ($this->is_test_group !== $v || $this->isNew()) {
			$this->is_test_group = $v;
			$this->modifiedColumns[] = ContactGroupPeer::IS_TEST_GROUP;
		}
	...
	public function setLegend($v)
	{
		...
		if ($this->legend !== $v) {
			$this->legend = $v;
			$this->modifiedColumns[] = ContactGroupPeer::LEGEND;
		}
	...
	public function setIsArchived($v)
	{
		...
		if ($this->is_archived !== $v || $this->isNew()) {
			$this->is_archived = $v;
			$this->modifiedColumns[] = ContactGroupPeer::IS_ARCHIVED;
		}
	...
	public function setColor($v)
	{
		...
		if ($this->color !== $v) {
			$this->color = $v;
			$this->modifiedColumns[] = ContactGroupPeer::COLOR;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->is_test_group = ($row[$startcol + 3] !== null) ? (boolean) $row[$startcol + 3] : null;
			$this->legend = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			...
			return $startcol + 9; // 9 = ContactGroupPeer::NUM_COLUMNS - ContactGroupPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[1] => $this->getSlug(),
			$keys[2] => $this->getName(),
			$keys[3] => $this->getIsTestGroup(),
			$keys[4] => $this->getLegend(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setIsTestGroup($arr[$keys[3]]);
		if (array_key_exists($keys[4], $arr)) $this->setLegend($arr[$keys[4]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ContactGroupPeer::SLUG)) $criteria->add(ContactGroupPeer::SLUG, $this->slug);
		if ($this->isColumnModified(ContactGroupPeer::NAME)) $criteria->add(ContactGroupPeer::NAME, $this->name);
		if ($this->isColumnModified(ContactGroupPeer::IS_TEST_GROUP)) $criteria->add(ContactGroupPeer::IS_TEST_GROUP, $this->is_test_group);
		if ($this->isColumnModified(ContactGroupPeer::LEGEND)) $criteria->add(ContactGroupPeer::LEGEND, $this->legend);
		if ($this->isColumnModified(ContactGroupPeer::IS_ARCHIVED)) $criteria->add(ContactGroupPeer::IS_ARCHIVED, $this->is_archived);
		if ($this->isColumnModified(ContactGroupPeer::COLOR)) $criteria->add(ContactGroupPeer::COLOR, $this->color);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setIsTestGroup($this->is_test_group);
	 ...
	 * related ContactContactGroups from storage. If this ContactGroup is new, it will return
		...
		if ($this->collContactContactGroups === null) {
			if ($this->isNew()) {
			   $this->collContactContactGroups = array();
				...
				$criteria->add(ContactContactGroupPeer::CONTACT_GROUP_ID, $this->id);
	 ...
	 */
	public function getContactContactGroupsJoinContact($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(ContactGroupPeer::DATABASE_NAME);
		}
		...
		if ($this->collContactContactGroups === null) {
			if ($this->isNew()) {
				...
				$this->collContactContactGroups = ContactContactGroupPeer::doSelectJoinContact($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this ContactGroup has previously been saved, it will retrieve
	 * related CampaignContactGroups from storage. If this ContactGroup is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collCampaignContactGroups === null) {
			if ($this->isNew()) {
			   $this->collCampaignContactGroups = array();
				...
				$criteria->add(CampaignContactGroupPeer::CONTACT_GROUP_ID, $this->id);
	 ...
	 * actually need in ContactGroup.
	 */
	public function getCampaignContactGroupsJoinCampaign($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(ContactGroupPeer::DATABASE_NAME);
		}
		...
		if ($this->collCampaignContactGroups === null) {
			if ($this->isNew()) {
				...
				$this->collCampaignContactGroups = CampaignContactGroupPeer::doSelectJoinCampaign($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseContactGroup:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseContactGroup::%s', $method));
	  }
