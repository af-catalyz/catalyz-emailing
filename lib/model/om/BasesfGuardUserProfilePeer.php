...
abstract class BasesfGuardUserProfilePeer {
	...
	public static function clearRelatedInstancePool()
	{
		...
		// invalidate objects in LandingPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$criteria->add(CampaignPeer::CREATED_BY, $obj->getId());
			$affectedRows += CampaignPeer::doDelete($criteria, $con);

			// delete related Landing objects
			$criteria = new Criteria(LandingPeer::DATABASE_NAME);
			
			$criteria->add(LandingPeer::CREATED_BY, $obj->getId());
			$affectedRows += LandingPeer::doDelete($criteria, $con);
		}
		return $affectedRows;
	}
