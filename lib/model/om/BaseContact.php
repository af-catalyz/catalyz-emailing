...
abstract class BaseContact extends BaseObject  implements Persistent {
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->external_reference = ($row[$startcol + 6] !== null) ? (int) $row[$startcol + 6] : null;
			$this->custom1 = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
			$this->custom2 = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
			$this->custom3 = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
			$this->custom4 = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
			$this->custom5 = ($row[$startcol + 11] !== null) ? (string) $row[$startcol + 11] : null;
			$this->custom6 = ($row[$startcol + 12] !== null) ? (string) $row[$startcol + 12] : null;
			$this->custom7 = ($row[$startcol + 13] !== null) ? (string) $row[$startcol + 13] : null;
			$this->custom8 = ($row[$startcol + 14] !== null) ? (string) $row[$startcol + 14] : null;
			$this->custom9 = ($row[$startcol + 15] !== null) ? (string) $row[$startcol + 15] : null;
			$this->custom10 = ($row[$startcol + 16] !== null) ? (string) $row[$startcol + 16] : null;
			...
			return $startcol + 19; // 19 = ContactPeer::NUM_COLUMNS - ContactPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[6] => $this->getExternalReference(),
			$keys[7] => $this->getCustom1(),
			$keys[8] => $this->getCustom2(),
			$keys[9] => $this->getCustom3(),
			$keys[10] => $this->getCustom4(),
			$keys[11] => $this->getCustom5(),
			$keys[12] => $this->getCustom6(),
			$keys[13] => $this->getCustom7(),
			$keys[14] => $this->getCustom8(),
			$keys[15] => $this->getCustom9(),
			$keys[16] => $this->getCustom10(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[6], $arr)) $this->setExternalReference($arr[$keys[6]]);
		if (array_key_exists($keys[7], $arr)) $this->setCustom1($arr[$keys[7]]);
		if (array_key_exists($keys[8], $arr)) $this->setCustom2($arr[$keys[8]]);
		if (array_key_exists($keys[9], $arr)) $this->setCustom3($arr[$keys[9]]);
		if (array_key_exists($keys[10], $arr)) $this->setCustom4($arr[$keys[10]]);
		if (array_key_exists($keys[11], $arr)) $this->setCustom5($arr[$keys[11]]);
		if (array_key_exists($keys[12], $arr)) $this->setCustom6($arr[$keys[12]]);
		if (array_key_exists($keys[13], $arr)) $this->setCustom7($arr[$keys[13]]);
		if (array_key_exists($keys[14], $arr)) $this->setCustom8($arr[$keys[14]]);
		if (array_key_exists($keys[15], $arr)) $this->setCustom9($arr[$keys[15]]);
		if (array_key_exists($keys[16], $arr)) $this->setCustom10($arr[$keys[16]]);
