...
abstract class BaseCampaign extends BaseObject  implements Persistent {
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->prepared_content = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			$this->text_content = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
			$this->prepared_text_content = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
			$this->status = ($row[$startcol + 9] !== null) ? (int) $row[$startcol + 9] : null;
			$this->from_name = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
			$this->from_email = ($row[$startcol + 11] !== null) ? (string) $row[$startcol + 11] : null;
			$this->scheduled_at = ($row[$startcol + 12] !== null) ? (string) $row[$startcol + 12] : null;
			$this->schedule_type = ($row[$startcol + 13] !== null) ? (int) $row[$startcol + 13] : null;
			$this->test_type = ($row[$startcol + 14] !== null) ? (int) $row[$startcol + 14] : null;
			$this->test_user_list = ($row[$startcol + 15] !== null) ? (string) $row[$startcol + 15] : null;
			$this->target = ($row[$startcol + 16] !== null) ? (string) $row[$startcol + 16] : null;
			$this->reply_to_email = ($row[$startcol + 17] !== null) ? (string) $row[$startcol + 17] : null;
			$this->return_path_email = ($row[$startcol + 18] !== null) ? (string) $row[$startcol + 18] : null;
			$this->return_path_server = ($row[$startcol + 19] !== null) ? (string) $row[$startcol + 19] : null;
			$this->return_path_login = ($row[$startcol + 20] !== null) ? (string) $row[$startcol + 20] : null;
			$this->return_path_password = ($row[$startcol + 21] !== null) ? (string) $row[$startcol + 21] : null;
			$this->is_archived = ($row[$startcol + 22] !== null) ? (int) $row[$startcol + 22] : null;
			$this->google_analytics_enabled = ($row[$startcol + 23] !== null) ? (boolean) $row[$startcol + 23] : null;
			$this->google_analytics_source = ($row[$startcol + 24] !== null) ? (string) $row[$startcol + 24] : null;
			$this->google_analytics_medium = ($row[$startcol + 25] !== null) ? (string) $row[$startcol + 25] : null;
			$this->google_analytics_campaign_type = ($row[$startcol + 26] !== null) ? (int) $row[$startcol + 26] : null;
			$this->google_analytics_campaign_content = ($row[$startcol + 27] !== null) ? (string) $row[$startcol + 27] : null;
			$this->google_analytics_content = ($row[$startcol + 28] !== null) ? (string) $row[$startcol + 28] : null;
			$this->litmus_test_id = ($row[$startcol + 29] !== null) ? (string) $row[$startcol + 29] : null;
			$this->created_at = ($row[$startcol + 30] !== null) ? (string) $row[$startcol + 30] : null;
			$this->created_by = ($row[$startcol + 31] !== null) ? (int) $row[$startcol + 31] : null;
			...
			return $startcol + 33; // 33 = CampaignPeer::NUM_COLUMNS - CampaignPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[6] => $this->getPreparedContent(),
			$keys[7] => $this->getTextContent(),
			$keys[8] => $this->getPreparedTextContent(),
			$keys[9] => $this->getStatus(),
			$keys[10] => $this->getFromName(),
			$keys[11] => $this->getFromEmail(),
			$keys[12] => $this->getScheduledAt(),
			$keys[13] => $this->getScheduleType(),
			$keys[14] => $this->getTestType(),
			$keys[15] => $this->getTestUserList(),
			$keys[16] => $this->getTarget(),
			$keys[17] => $this->getReplyToEmail(),
			$keys[18] => $this->getReturnPathEmail(),
			$keys[19] => $this->getReturnPathServer(),
			$keys[20] => $this->getReturnPathLogin(),
			$keys[21] => $this->getReturnPathPassword(),
			$keys[22] => $this->getIsArchived(),
			$keys[23] => $this->getGoogleAnalyticsEnabled(),
			$keys[24] => $this->getGoogleAnalyticsSource(),
			$keys[25] => $this->getGoogleAnalyticsMedium(),
			$keys[26] => $this->getGoogleAnalyticsCampaignType(),
			$keys[27] => $this->getGoogleAnalyticsCampaignContent(),
			$keys[28] => $this->getGoogleAnalyticsContent(),
			$keys[29] => $this->getLitmusTestId(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[6], $arr)) $this->setPreparedContent($arr[$keys[6]]);
		if (array_key_exists($keys[7], $arr)) $this->setTextContent($arr[$keys[7]]);
		if (array_key_exists($keys[8], $arr)) $this->setPreparedTextContent($arr[$keys[8]]);
		if (array_key_exists($keys[9], $arr)) $this->setStatus($arr[$keys[9]]);
		if (array_key_exists($keys[10], $arr)) $this->setFromName($arr[$keys[10]]);
		if (array_key_exists($keys[11], $arr)) $this->setFromEmail($arr[$keys[11]]);
		if (array_key_exists($keys[12], $arr)) $this->setScheduledAt($arr[$keys[12]]);
		if (array_key_exists($keys[13], $arr)) $this->setScheduleType($arr[$keys[13]]);
		if (array_key_exists($keys[14], $arr)) $this->setTestType($arr[$keys[14]]);
		if (array_key_exists($keys[15], $arr)) $this->setTestUserList($arr[$keys[15]]);
		if (array_key_exists($keys[16], $arr)) $this->setTarget($arr[$keys[16]]);
		if (array_key_exists($keys[17], $arr)) $this->setReplyToEmail($arr[$keys[17]]);
		if (array_key_exists($keys[18], $arr)) $this->setReturnPathEmail($arr[$keys[18]]);
		if (array_key_exists($keys[19], $arr)) $this->setReturnPathServer($arr[$keys[19]]);
		if (array_key_exists($keys[20], $arr)) $this->setReturnPathLogin($arr[$keys[20]]);
		if (array_key_exists($keys[21], $arr)) $this->setReturnPathPassword($arr[$keys[21]]);
		if (array_key_exists($keys[22], $arr)) $this->setIsArchived($arr[$keys[22]]);
		if (array_key_exists($keys[23], $arr)) $this->setGoogleAnalyticsEnabled($arr[$keys[23]]);
		if (array_key_exists($keys[24], $arr)) $this->setGoogleAnalyticsSource($arr[$keys[24]]);
		if (array_key_exists($keys[25], $arr)) $this->setGoogleAnalyticsMedium($arr[$keys[25]]);
		if (array_key_exists($keys[26], $arr)) $this->setGoogleAnalyticsCampaignType($arr[$keys[26]]);
		if (array_key_exists($keys[27], $arr)) $this->setGoogleAnalyticsCampaignContent($arr[$keys[27]]);
		if (array_key_exists($keys[28], $arr)) $this->setGoogleAnalyticsContent($arr[$keys[28]]);
		if (array_key_exists($keys[29], $arr)) $this->setLitmusTestId($arr[$keys[29]]);
