...
abstract class BaseCampaign extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the web_tracker_enabled field.
	 * @var        int
	 */
	protected $web_tracker_enabled;
	...
	/**
	 * Get the [web_tracker_enabled] column value.
	 * 
	 * @return     int
	 */
	public function getWebTrackerEnabled()
	{
		return $this->web_tracker_enabled;
	}
	...
	/**
	 * Set the value of [web_tracker_enabled] column.
	 * 
	 * @param      int $v new value
	 * @return     Campaign The current object (for fluent API support)
	 */
	public function setWebTrackerEnabled($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->web_tracker_enabled !== $v) {
			$this->web_tracker_enabled = $v;
			$this->modifiedColumns[] = CampaignPeer::WEB_TRACKER_ENABLED;
		}

		return $this;
	} // setWebTrackerEnabled()
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->web_tracker_enabled = ($row[$startcol + 31] !== null) ? (int) $row[$startcol + 31] : null;
			$this->created_at = ($row[$startcol + 32] !== null) ? (string) $row[$startcol + 32] : null;
			$this->created_by = ($row[$startcol + 33] !== null) ? (int) $row[$startcol + 33] : null;
			$this->updated_at = ($row[$startcol + 34] !== null) ? (string) $row[$startcol + 34] : null;
			$this->resetModified();
			...
			return $startcol + 35; // 35 = CampaignPeer::NUM_COLUMNS - CampaignPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 30:
				...
				break;
			case 31:
				return $this->getWebTrackerEnabled();
				break;
			case 32:
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[31] => $this->getWebTrackerEnabled(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[31], $arr)) $this->setWebTrackerEnabled($arr[$keys[31]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CampaignPeer::WEB_TRACKER_ENABLED)) $criteria->add(CampaignPeer::WEB_TRACKER_ENABLED, $this->web_tracker_enabled);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setWebTrackerEnabled($this->web_tracker_enabled);
