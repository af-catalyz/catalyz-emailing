...
abstract class BaseWebPage extends BaseObject  implements Persistent {
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = WebPagePeer::NAME;
		}
	...
	public function setUrl($v)
	{
		...
		if ($this->url !== $v) {
			$this->url = $v;
			$this->modifiedColumns[] = WebPagePeer::URL;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = WebPagePeer::NUM_COLUMNS - WebPagePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(WebPagePeer::NAME)) $criteria->add(WebPagePeer::NAME, $this->name);
		if ($this->isColumnModified(WebPagePeer::URL)) $criteria->add(WebPagePeer::URL, $this->url);
