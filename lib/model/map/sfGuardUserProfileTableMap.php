...
class sfGuardUserProfileTableMap extends TableMap {
    ...
    $this->addRelation('Campaign', 'Campaign', RelationMap::ONE_TO_MANY, array('id' => 'created_by', ), 'CASCADE', null);
    $this->addRelation('Landing', 'Landing', RelationMap::ONE_TO_MANY, array('id' => 'created_by', ), 'CASCADE', null);
	} // buildRelations()
