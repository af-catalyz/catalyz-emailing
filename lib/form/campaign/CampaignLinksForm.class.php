...
class CampaignAnalyticsForm extends BaseCampaignForm {
	...
	//	$widgets['google_analytics_enabled'] = new czWidgetFormInputCheckbox();
		...
		$widgets['google_analytics_source'] = new sfWidgetFormInput(array(), array('size' => 50));
		...
		$widgets['google_analytics_medium'] = new sfWidgetFormInput(array(), array('size' => 50));
		...
		$widgets['google_analytics_content'] = new sfWidgetFormInput(array(), array('size' => 50));
