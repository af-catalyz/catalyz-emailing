...
class CampaignFromZipForm extends BaseCampaignForm {
...
//			$this['name'],
		...
		$this->widgetSchema['archive'] = new sfWidgetFormInputFile(array('label' => 'Archive'),array('class' => 'input-file'));
		$allowedMimeTypes[] = 'application/zip';
		$this->validatorSchema['archive'] = new sfValidatorFile(array('required' => true, 'mime_types' =>  $allowedMimeTypes), array('required' => 'Vous devez fournir une archive valide','mime_types'=>'Le format de l\'archive n\'est pas compatible. Veuillez fournir une archive au format Zip(zip) pour importer votre campagne. (%mime_type%)'));;
	}
