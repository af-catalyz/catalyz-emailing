<?php
class asfoCalendrier2Form extends sfForm {
	public function configure()
	{
		...
		$choices_tab['Général']['administratif']='Gestion des compétences';
		$choices_tab['Général']['management']='Stratégie';
		$choices_tab['Général']['qse']='Management';
		$choices_tab['Général']['technique']='Compétences transverses';
		$choices_tab['Général']['strategie']=' Compétences métiers';
		//$choices_tab['Général']['gestion']='Gestion des compétences';

		$choices_tab['Santé']=array();
		$choices_tab['Santé']['gestion_competence']='Gestion des compétences';
		$choices_tab['Santé']['management_hommes']='Management des hommes et des équipes';
		$choices_tab['Santé']['gestion_projet']='Gestion de projets, methodes et organisation';
		$choices_tab['Santé']['gestion_sociale']='Gestion sociale et juridique des ressources humaines';
		$choices_tab['Santé']['communication']='Communication et efficacité personnelle';
		$choices_tab['Santé']['management_qualite']='Management de la qualité, de la sécurité et de la santé';
		$choices_tab['Santé']['accueil']='Accueil et secrétariat';
		$choices_tab['Santé']['pratiques']='Pratiques professionnelles';
