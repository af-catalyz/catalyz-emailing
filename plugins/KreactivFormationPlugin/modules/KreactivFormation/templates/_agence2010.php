...
<body marginheight="0" marginwidth="0" leftmargin="0" topmargin="0" bgcolor="#f8f7ee">
                		...
                		<tr>
                        	...
                        	<td valign="top">
                				<table bgcolor="#f8f7ee"  width="310" cellspacing="0" cellpadding="0">
                                	<tr>
                                    	<td>
                							<table width="310" cellspacing="0" cellpadding="0">
                                            	...
                                            	<tr>
                                                	<td bgcolor="#7f7b69" width="100%" height="3px"></td>
                                                </tr>
                                            </table>
                                            <table width="310" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
                                            	<tr>
                                            	<tr>
                                    ...
                                    <tr>
                                    	<td bgcolor="#7f7b69" width="310" height="3px"></td>
                                    </tr>
                                    <tr>

                                   	  <td>
                                          <table width="310" cellspacing="0" cellpadding="0" bgcolor="#b6b093">
                                           	  <tr>
                                           	  <tr>
                                                  <td width="15" style="font-size: 0; line-height: 0;">
                                                            ...
                                                            <tr>
                                                              <td width="95" height="29" valign="bottom" align="center" style="font-size: 0; line-height: 0;">
                                                                ...
                                                                <td style="line-height: 13px;">
                                                                    ...
                                                                    <font color="#4D4D4D" face="trebuchet MS, Arial, Helvetica, sans-serif" style="font-size: 18px; line-height: 13px; display: block; text-transform:uppercase;" size="2">dossier</font>                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                </tr>
                                            	<tr>
                                                  <td bgcolor="#4D4D4D" width="100%" height="3px"></td>
                                                </tr>
                                            </table>
                                            <table width="310" cellspacing="0" cellpadding="0" bgcolor="#d6dcde">
                                            	<tr>
...
faites une bonne 1ère impression !</strong></font>
                                    ...
                                    <tr>
                                    	<td bgcolor="#4D4D4D" width="310" height="3px"></td>
                                    </tr>
                                </table>
                          </td>
                            <td width="25" style="font-size: 0; line-height: 0;">
                        	...
                        	<td valign="top">
                				<table bgcolor="#f8f7ee"  width="100%" cellspacing="0" cellpadding="0">
                                	<tr>
                                    	<td>
                							<table width="100%" cellspacing="0" cellpadding="0">
                                            	...
                                            	<tr>
                                                	<td bgcolor="#b3b3b3" width="100%" height="3px"></td>
                                            	...
                                            	<tr>
                                            		...
                                            		<td valign="top" style="font-size: 0; line-height: 0;">
                                                        ...
                                                        <font color="#ffffff" face=" Arial, Helvetica, sans-serif" style="font-size: 11px; line-height: 13px; display: block;" size="2">
                                                            ...
                                                            <font style="display: block;">→ décliner notre stratégie « clients et produits »</font>
                                    ...
                                    <tr>
                                    	...
                                    	<td bgcolor="#b3b3b3" width="310" height="3px"></td>
                                    </tr>
                                </table>
                            </td>
                            <td width="25" style="font-size: 0; line-height: 0;">
                                	...
                                	<tr>
                                    	<td>
                							<table width="100%" cellspacing="0" cellpadding="0">
                                            	...
                                            	<tr>
                                                	<td bgcolor="#b06a23" width="100%" height="3px"></td>
                                                </tr>
                                            </table>
...
Pour les clients habitués à commander une prestation spécifique, c’est aussi un moyen d’avoir une vue globale de l’entreprise.</font></td>
                      <td width="15" style="font-size: 0; line-height: 0;">
                                    ...
                                    <tr>
                                    	<td bgcolor="#b06a23" width="310" height="3px"></td>
                                    	...
                                    	<td>
                							<table width="100%" cellspacing="0" cellpadding="0">
                                            	...
                                            	<tr>
                                                	...
                                                	<td bgcolor="#346984" width="100%" height="3px"></td>
                                                </tr>
                                            </table>
                                            <table width="100%" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
                                            	<tr>
...
Pour les clients habitués à commander une prestation spécifique, c’est aussi un moyen d’avoir une vue globale de l’entreprise.</font></td>
                      <td width="15" style="font-size: 0; line-height: 0;">
                                    ...
                                    <tr>
                                    	<td bgcolor="#346984" width="310" height="3px"></td>
                                    	...
                                    	<td>
                							<table width="100%" cellspacing="0" cellpadding="0">
                                            	...
                                            	<tr>
                                                	...
                                                	<td bgcolor="#80a93e" width="100%" height="3px"></td>
                                                </tr>
                                            </table>
                                            <table width="100%" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
                                            	<tr>
...
Pour les clients habitués à commander une prestation spécifique, c’est aussi un moyen d’avoir une vue globale de l’entreprise.</font></td>
                      <td width="15" style="font-size: 0; line-height: 0;">
                                    ...
                                    <tr>
                                    	<td bgcolor="#80a93e" width="310" height="3px"></td>
            	...
            	<table bgcolor="#80a93e" width="100%" cellspacing="0" cellpadding="0">
                	<tr>
            ...
            <font color="#8c8571">Tél. : </font>+33 (0)5 63 66 71 52 - <font color="#8c8571">Fax : </font>+33 (0)5 63 66 96 26 - <font color="#8c8571">Port. : </font>+33 (0)6 68 61 82 82<br/>

            <a href="www.kreactiv-formation.fr"><font color="#8c8571">www.kreactiv-formation.fr</font></a> - <a href="#"><font color="#8c8571">contact@kreactiv.fr</font></a></font>
                                    </td>
                                </tr>
                            </table>
                      </td>
                    ...
                    <tr>
                    	<td bgcolor="#efecd9"  width="100%" style="font-size:9px; line-height:9px;" align="center">
                        	<font color="#605e5f" face="Arial, Helvetica, sans-serif" style="font-size: 9px; line-height: 9px; display: block;" size="2">Conformément à la loi Informatique et Libertés du 06/01/1978,vous disposez d'un droit d'accès, de rectification et d'opposition aux informations<br/>
vous concernant qui peut s'exercer par e-mail à <a href="#"><font color="#8c8571">contact@kreactiv.fr</font></a> ou par courrier en indiquant votre nom et prénom.</font>
