...
class KreactivNewsletter20111020CampaignTemplateHandler extends CampaignTemplateHandler {
	...
	public function compute($parameters)
	{
		...
		return get_partial('KreactivFormation/newsletter20111020', array('parameters' => $parameters));
	}
