...
class SemAutomationCampaign02CampaignTemplateHandler extends CampaignTemplateHandler {
	public function createEditWidget()
	{
		$formClass = 'semAutomationCampaign02Form';
	...
	public function compute($parameters)
	{
		...
		return get_partial('SemAutomation/campaign02', array('parameters' => $parameters));
	}

	public function getEditPartialName(){
		return 'SemAutomation/campaign02_edit';
	}
}
