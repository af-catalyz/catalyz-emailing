...
class SemAutomationViergeCampaignTemplateHandler extends CampaignTemplateHandler {
	public function createEditWidget()
	{
		$formClass = 'semAutomationViergeForm';
	...
	public function compute($parameters)
	{
		...
		return get_partial('SemAutomation/semAutomationVierge', array('parameters' => $parameters));
	}

	public function getEditPartialName(){
		return 'SemAutomation/semAutomationVierge_edit';
	}
}
