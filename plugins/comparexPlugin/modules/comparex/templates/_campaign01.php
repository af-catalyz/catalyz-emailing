       		...
       		<table width="702" align="center" cellspacing="0" cellpadding="0" border="0">
	       		<tr valign="top">
	           		...
	           		<td width="428" bgcolor="#171613">
						...
						<?php $renderer = new CatalyzEmailRenderer('Arial, sans-serif','#FFFFFF','text-align:left; line-height:16px; font-size:11px; color:#FFFFFF');
						...
						<table width="389" cellspacing="0" cellpadding="0" border="0">
							...
							<tr valign="top">
								<td>
			       					...
			       					<?php echo nl2br($parameters['footer']) ?>
									</font>
								</td>
							</tr>
							<tr valign="top">
