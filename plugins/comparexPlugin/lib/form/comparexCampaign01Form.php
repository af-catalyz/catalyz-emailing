...
class comparexCampaign01Form extends czForm {
    ...
    public function configure()
    {
    	...
    	$this->addWysiwygField('edito', 'Editorial', array('height' => 300, 'style' => 'width: 400px'));
        ...
        $this->addWysiwygField('bottom_text', 'Fin de newsletter', array('height' => 300, 'style' => 'width: 400px'));

        $this->addTextareaField('footer', 'Coordonnées', array('height' => 300, 'style' => 'width: 400px'));
