...
<body bgcolor="FFFFFF" vlink="#787878" link="#787878" alink="#787878">
				...
				<table width="536" bgcolor="#dfdfdf" cellspacing="0" cellpadding="0" border="0">
					<tr style="line-height: 0; font-size: 0;">
						<td colspan="3" bgcolor="#f2f2f2">
							<img  src="<?php echo CatalyzEmailing::getApplicationUrl() ?>/newtechPlugin/images/campaign01/table_sep.gif" width="1" height="20" alt="" style="display: block;" border="0" />
						</td>
					</tr>
	...
	<table width="689" bgcolor="#FFFFFF" align="center" cellspacing="0" cellpadding="0" border="0">
		<tr>
			...
			<td width="536"align="center"><font face="Tahoma, Geneva, sans-serif" style="line-height: 12px; font-size: 10px;" size="2" color="#666666">Conformément à la loi Informatique et Libertés du 06/01/1978, vous disposez d'un droit d'accès,<br />
